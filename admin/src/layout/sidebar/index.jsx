...
import SidebarLinkGroup from "./siderbar-link-group/index.jsx";
    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/" className="flex gap-x-2 items-center">
                ...
                {links.map((link) => (
                  <li key={link.to} className="mb-2 last:mb-0">
                    <NavLink
                      ...
                      to={link.to}
                      className={({ isActive }) => // isActive is destructured from the render prop
                        `block transition duration-150 truncate group px-3 py-2 rounded-lg ${isActive
                          ? "bg-violet-500/10 text-violet-600 dark:text-violet-400"
                          : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 hover:bg-gray-100/50 dark:hover:text-gray-200 dark:hover:bg-gray-800/30"
                        }`
                      }
                    >
                      {({ isActive }) => ( // Render prop to access isActive for the icon
                        <div className="flex items-center">
                          <FontAwesomeIcon
                            icon={link.icon}
